...
function MainComponent() {
  ...
  const errorMessages = {
    ...
    CredentialsSignin:
      "Incorrect email or password. If you don’t have an account yet, sign up first.",
  ...
  const onSubmit = async (e) => {
    ...
    // IMPORTANT: auth adapter does exact email matching (case-sensitive), so always normalize.
